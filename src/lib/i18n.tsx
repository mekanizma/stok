...
export const translations = {
  ...
  assetsInventoryDesc: { tr: 'Laptop, desktop ve diğer demirbaşları ekleyin; Stok Ver ile zimmete çıkarın.', en: 'Add laptops, desktops and other assets; issue stock to assign them.' },
  addAssetQtyHint: { tr: 'Aynı ürünü birden fazla eklemek için adet girin. Kısmi zimmette kalan stok Demirbaşlar’da kalır.', en: 'Enter quantity to add more than one of the same item. Remaining stock stays on Assets after a partial issue.' },
  issueGoesToDeployed: { tr: 'Verildiğinde kayıt doğrudan Zimmetli bölümüne gider.', en: 'When issued, the record goes straight to Deployed.' },
  deployedAssets: { tr: 'Zimmetli', en: 'Deployed' },
  checkedInAssets: { tr: 'Teslim Alınanlar', en: 'Returned' },
  scanAsset: { tr: 'QR / Barkod', en: 'QR / Barcode' },
  ...
  serialOptional: { tr: 'İsteğe bağlı', en: 'Optional' },
  ...
  selectFromDemirbas: { tr: 'Demirbaşlardan seç', en: 'Select from assets' },
  selectFromDemirbasHint: { tr: 'Hazır stoktaki demirbaşı seçince marka, model ve seri no otomatik dolar.', en: 'Selecting a ready asset fills brand, model and serial automatically.' },
  selectFromInventory: { tr: 'Stoktan seç (Demirbaş / Aksesuar)', en: 'Select from stock (Asset / Accessory)' },
  selectFromInventoryHint: { tr: 'Hazır demirbaş veya aksesuar seçince bilgiler otomatik dolar.', en: 'Selecting a ready asset or accessory fills the fields automatically.' },
  manualZimmetEntry: { tr: 'Manuel giriş (yeni ürün)', en: 'Manual entry (new item)' },
  noReadyDemirbas: { tr: 'Hazır demirbaş yok. Önce Demirbaşlar sayfasından ürün ekleyin.', en: 'No ready assets. Add items on the Assets page first.' },
  noReadyInventory: { tr: 'Hazır demirbaş veya aksesuar yok.', en: 'No ready assets or accessories.' },
  ...
  checkInLocation: { tr: 'Teslim alınan konum', en: 'Return location' },
  ...
  scanAssetDesc: { tr: 'Kamerayı açın; barkod veya QR algılanınca ürün açılır ya da ekleme formu gelir.', en: 'Open the camera; a barcode or QR opens the product or the add form.' },
  scanHint: { tr: 'Kamerayı açıp etiketteki QR veya barkodu okutun. Kayıt varsa ürüne, yoksa ekleme ekranına gider.', en: 'Open the camera and scan the QR or barcode. Existing items open the product; new codes open the add form.' },
  scanCameraAlign: { tr: 'Barkodu veya QR kodu çerçeveye hizalayın.', en: 'Align the barcode or QR code inside the frame.' },
  scanFilledFromCode: { tr: 'Kod kameradan okundu; adı ve diğer bilgileri tamamlayın.', en: 'Code was read from the camera; complete the name and other details.' },
  ...
  scanOpenAsset: { tr: 'Demirbaşı aç', en: 'Open asset' },
  ...
  scanLabelTip: { tr: 'Etiket yazdırıp yapıştırın. QR ve barkod hem mevcut ürüne hem yeni eklemeye gider.', en: 'Print and stick labels. QR and barcodes open an existing product or the add form.' },
  printLabel: { tr: 'Etiket Yazdır', en: 'Print label' },
  printLabelDesc: { tr: 'QR kodlu demirbaş etiketi', en: 'Asset label with QR code' },
  labelScanHint: { tr: 'QR okut → detay / zimmet / iade', en: 'Scan QR → detail / checkout / check-in' },
  copyAssetLink: { tr: 'Linki kopyala', en: 'Copy link' },
  linkCopied: { tr: 'Link kopyalandı.', en: 'Link copied.' },
  quickIssue: { tr: 'Hızlı zimmet', en: 'Quick checkout' },
  qrCode: { tr: 'QR Kod', en: 'QR Code' },
  ...
  issueStock: { tr: 'Stok Ver', en: 'Issue stock' },
  issueConfirm: { tr: 'Ver', en: 'Issue' },
  issueQty: { tr: 'Verilecek adet', en: 'Quantity to issue' },
  issueLocation: { tr: 'Verilen yer', en: 'Location' },
  issuePerson: { tr: 'Alan kişi', en: 'Received by' },
  issuePersonPlaceholder: { tr: 'Ad soyad yazın', en: 'Type full name' },
  givenTo: { tr: 'Verilen yer / kişi', en: 'Issued to' },
  givenToPlaceholder: { tr: 'Örn. Rektörlük, Lab 3, Ahmet Yılmaz', en: 'e.g. Main office, Lab 3, Jane Doe' },
  givenToHint: { tr: 'Yer veya kişi seçin; isterseniz aşağıya serbest yazın.', en: 'Pick a place or person, or type it below.' },
  givenWhere: { tr: 'Nereye verildi', en: 'Issued to' },
  issueHistory: { tr: 'Veriliş geçmişi', en: 'Issue history' },
  issueDetail: { tr: 'Veriliş detayı', en: 'Issue details' },
  issuedAt: { tr: 'Veriliş zamanı', en: 'Issued at' },
  close: { tr: 'Kapat', en: 'Close' },
  noIssuesYet: { tr: 'Henüz veriliş kaydı yok.', en: 'No issues recorded yet.' },
  issueNotePlaceholder: { tr: 'İsteğe bağlı not', en: 'Optional note' },
  selectOptional: { tr: 'Seçiniz (isteğe bağlı)', en: 'Select (optional)' },
  pcs: { tr: 'adet', en: 'pcs' },
  notEnoughStock: { tr: 'Yeterli stok yok.', en: 'Not enough stock.' },
  givenToRequired: { tr: 'Verilen yer veya kişiyi yazın.', en: 'Enter where or to whom it was issued.' },

  stockAlertTitle: { tr: 'Kritik stok e-posta uyarısı', en: 'Critical stock email alerts' },
  stockAlertDesc: { tr: 'Aksesuar ve sarf malzemelerinde stok eşiğin altına düşünce e-posta gönderir.', en: 'Sends email when accessory or consumable stock falls to the threshold.' },
  stockAlertEnabled: { tr: 'E-posta uyarılarını aç', en: 'Enable email alerts' },
  stockAlertEnabledHint: { tr: 'Stok güncellendiğinde veya “Şimdi kontrol et” ile gönderilir.', en: 'Sent when stock is updated or via “Check now”.' },
  stockAlertEmails: { tr: 'Alıcı e-postalar', en: 'Recipient emails' },
  stockAlertEmailsHint: { tr: 'Birden fazla adresi virgülle ayırın.', en: 'Separate multiple addresses with commas.' },
  stockAlertFrom: { tr: 'Gönderen (From)', en: 'From address' },
  stockAlertCooldown: { tr: 'Tekrar uyarma süresi (saat)', en: 'Resend cooldown (hours)' },
  stockAlertCooldownHint: { tr: 'Aynı kalem için yeniden e-posta göndermeden önce beklenecek süre.', en: 'Minimum hours before re-alerting the same item.' },
  stockAlertWebhook: { tr: 'Webhook URL (isteğe bağlı)', en: 'Webhook URL (optional)' },
  stockAlertWebhookHint: { tr: 'Zapier / Make gibi servislere JSON bildirim gönderir.', en: 'Posts JSON alerts to Zapier / Make, etc.' },
  stockAlertResendHint: { tr: 'E-posta Turhost SMTP (envanter@e-final.com) ile gönderilir. Secrets: SMTP_HOST, SMTP_PORT, SMTP_USER, SMTP_PASS.', en: 'Email is sent via Turhost SMTP. Secrets: SMTP_HOST, SMTP_PORT, SMTP_USER, SMTP_PASS.' },
  stockAlertResendReady: { tr: 'SMTP tanımlı', en: 'SMTP configured' },
  stockAlertResendMissing: { tr: 'SMTP eksik', en: 'SMTP missing' },
  stockAlertCriticalCount: { tr: '{count} kritik kalem', en: '{count} critical items' },
  stockAlertSaved: { tr: 'Uyarı ayarları kaydedildi.', en: 'Alert settings saved.' },
  stockAlertSendTest: { tr: 'Test e-postası gönder', en: 'Send test email' },
  stockAlertTestSent: { tr: 'Test bildirimi gönderildi.', en: 'Test notification sent.' },
  stockAlertScanNow: { tr: 'Şimdi kontrol et', en: 'Check now' },
  stockAlertScanSent: { tr: '{count} kalem için uyarı gönderildi.', en: 'Alert sent for {count} items.' },
  stockAlertScanDone: { tr: 'Kontrol tamamlandı.', en: 'Check completed.' },
  stockAlertNoCritical: { tr: 'Kritik stok yok.', en: 'No critical stock.' },
  stockAlertDisabled: { tr: 'Uyarılar kapalı. Önce açıp kaydedin.', en: 'Alerts are off. Enable and save first.' },
  dashboardCriticalStock: { tr: 'Kritik stok uyarıları', en: 'Critical stock alerts' },
  dashboardCriticalStockDesc: { tr: 'Minimum stok eşiğinin altındaki aksesuar ve sarf malzemeler', en: 'Accessories and consumables at or below minimum stock' },
  dashboardCriticalStockOk: { tr: 'Şu an kritik stok yok.', en: 'No critical stock right now.' },
  minThreshold: { tr: 'Eşik', en: 'Threshold' },
  remainingShort: { tr: 'Kalan {remaining}', en: '{remaining} left' },
