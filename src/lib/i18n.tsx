...
export const translations = {
  ...
  stockAlertResendHint: { tr: 'E-posta için Supabase Edge Function Secrets içine RESEND_API_KEY ekleyin ve stock-alert fonksiyonunu deploy edin. Resend’de doğrulanmış domain kullanın.', en: 'Add RESEND_API_KEY to Supabase Edge Function secrets and deploy stock-alert. Use a verified Resend domain.' },
  stockAlertResendReady: { tr: 'Resend anahtarı tanımlı', en: 'Resend key configured' },
  stockAlertResendMissing: { tr: 'Resend anahtarı eksik', en: 'Resend key missing' },
